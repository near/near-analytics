...
from aggregations import (
    ...
    DailyAddKeyByAppCount,
    DailyNewAccountsByAppCount,
)
...
STATS = {
    ...
    "daily_add_key_by_app_count": DailyAddKeyByAppCount,
    "daily_new_accounts_by_app_count": DailyNewAccountsByAppCount,
}
